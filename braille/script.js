function check() {
  var out = parseInt(
    Array.from(
      (document.getElementById("01").checked == true ? "1" : "0") +
        (document.getElementById("02").checked == true ? "1" : "0") +
        (document.getElementById("03").checked == true ? "1" : "0") +
        (document.getElementById("04").checked == true ? "1" : "0") +
        (document.getElementById("05").checked == true ? "1" : "0") +
        (document.getElementById("06").checked == true ? "1" : "0") +
        (document.getElementById("07").checked == true ? "1" : "0") +
        (document.getElementById("08").checked == true ? "1" : "0")
    )
      .reverse()
      .join(""),
    2
  ...
  document.getElementById("textarea").value += String.fromCodePoint(
    parseInt(out2, 16)
  );
  document.getElementById("output").innerText = "u" + out2;
  if (document.getElementById("clearafter").checked == true) {
    clearnums();
  }
}
...
function left() {
  ...
  document.getElementById("02").checked = true;
  document.getElementById("03").checked = true;
  if (document.getElementById("dontclear").checked == false) {
    document.getElementById("04").checked = false;
  }
  if (document.getElementById("dontclear").checked == false) {
    document.getElementById("05").checked = false;
...
function xswap() {
  let states = [
    document.getElementById("01").checked,
    document.getElementById("02").checked,
    document.getElementById("03").checked,
    document.getElementById("04").checked,
    document.getElementById("05").checked,
    document.getElementById("06").checked,
    document.getElementById("07").checked,
    document.getElementById("08").checked,
  ];
...
document.getElementById("01").onmouseover = function () {
  if (document.getElementById("hover").checked == true) {
    document.getElementById("01").checked =
      document.getElementById("01").checked == true ? false : true;
  }
};
document.getElementById("02").onmouseover = function () {
  if (document.getElementById("hover").checked == true) {
    document.getElementById("02").checked =
      document.getElementById("02").checked == true ? false : true;
  }
};
document.getElementById("03").onmouseover = function () {
  if (document.getElementById("hover").checked == true) {
    document.getElementById("03").checked =
      document.getElementById("03").checked == true ? false : true;
  }
};
document.getElementById("04").onmouseover = function () {
  if (document.getElementById("hover").checked == true) {
    document.getElementById("04").checked =
      document.getElementById("04").checked == true ? false : true;
  }
};
document.getElementById("05").onmouseover = function () {
  if (document.getElementById("hover").checked == true) {
    document.getElementById("05").checked =
      document.getElementById("05").checked == true ? false : true;
  }
};
document.getElementById("06").onmouseover = function () {
  if (document.getElementById("hover").checked == true) {
    document.getElementById("06").checked =
      document.getElementById("06").checked == true ? false : true;
  }
};
document.getElementById("07").onmouseover = function () {
  if (document.getElementById("hover").checked == true) {
    document.getElementById("07").checked =
      document.getElementById("07").checked == true ? false : true;
  }
};
document.getElementById("08").onmouseover = function () {
  if (document.getElementById("hover").checked == true) {
    document.getElementById("08").checked =
      document.getElementById("08").checked == true ? false : true;
  }
};
